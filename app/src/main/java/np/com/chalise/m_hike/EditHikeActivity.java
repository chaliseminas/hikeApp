...
public class EditHikeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etDifficulty.setText(getIntent().getStringExtra("difficulty"));
        etParkingAvailable.setText(getIntent().getStringExtra("parking"));
        etAccommodation.setText(getIntent().getStringExtra("accommodation"));
        etLimitation.setText(getIntent().getStringExtra("limitation"));
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EditHikeActivity.this, MainActivity.class));
                finish();
            }
        });
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.isEmpty()) {
                    ...
                    try {
                        dbHelper.updateCourse(id, name, location, date, parkingAvailable, length, difficultyLevel, description,
                                accommodationAvailable, personLimit);
                        Toast.makeText(EditHikeActivity.this, "Hike details updated successfully.", Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        Toast.makeText(EditHikeActivity.this, "Something went wrong, please try again later.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
